...
[![Build Status](https://travis-ci.org/cheekybits/genny.svg?branch=master)](https://travis-ci.org/cheekybits/genny) [![GoDoc](https://godoc.org/github.com/MrLYC/genny/parse?status.png)](http://godoc.org/github.com/MrLYC/genny/parse)

Install:

```
go get github.com/MrLYC/genny
```
...
We have started building a [library of common things](https://github.com/MrLYC/gennylib), and you can use `genny get` to generate the specific versions you need.
...
To see a real example of how to use `genny` with `go generate`, look in the [example/go-generate directory](https://github.com/MrLYC/genny/tree/master/examples/go-generate).
...
Given [this generic Go code](https://github.com/MrLYC/genny/tree/master/examples/queue) which compiles and is tested:

```go
package queue

import "github.com/MrLYC/genny/generic"
...
// see https://github.com/MrLYC/genny
...
Check out the [test code files](https://github.com/MrLYC/genny/tree/master/parse/test) for more real examples.
...
### Contributions
  ...
  * See the [API documentation for the parse package](http://godoc.org/github.com/MrLYC/genny/parse)
  * Please do TDD
  * All input welcome
